...
#define GTM_INVALID_R_DISPLS 0x0003  // GTMatrix failed to create with invalid r_displs 
#define GTM_INVALID_C_DISPLS 0x0004  // GTMatrix failed to create with invalid c_displs 
#define GTM_INVALID_BLOCK    0x0005  // GTMatrix failed to access a block with invalid range
#define GTM_INVALID_SRC_LD   0x0006  // GTMatrix failed to access a block with invalid src_ld
#define GTM_NO_BATCHED_GET   0x0007  // GTMatrix is not in batched get mode
#define GTM_NO_BATCHED_PUT   0x0008  // GTMatrix is not in batched put mode
#define GTM_NO_BATCHED_ACC   0x0009  // GTMatrix is not in batched acc mode
#define GTM_IN_BATCHED_GET   0x000A  // GTMatrix is in batched get mode
#define GTM_IN_BATCHED_PUT   0x000B  // GTMatrix is in batched put mode
#define GTM_IN_BATCHED_ACC   0x000C  // GTMatrix is in batched acc mode
#define GTM_NOT_SQUARE_MAT   0x000D  // GTMatrix failed to symmetrize a non-square matrix
